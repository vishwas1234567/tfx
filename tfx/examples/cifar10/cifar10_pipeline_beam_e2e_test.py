...
"""E2E Tests for tfx.examples.cifar10.cifar10_pipeline_beam."""
...
class Cifar10PipelineBeamEndToEndTest(tf.test.TestCase):
  ...
  def setUp(self):
    super(Cifar10PipelineBeamEndToEndTest, self).setUp()
    ...
    self._module_file = os.path.join(
        os.path.dirname(__file__), 'cifar10_utils.py')
  ...
  def testCifar10PipelineBeam(self):
    BeamDagRunner().run(
